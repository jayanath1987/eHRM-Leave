...
<!--                               <option value="<?php //echo $i ?>"><?php //echo $i; ?></option>-->
			...
			<br class="clear"/>
                        ...
                        <div class="centerCol" style="padding-top: 8px;">
                            <input placeholder="<?php echo  $dateDisplayHint; ?>" id="txtLeaveStartDate" type="text" name="txtLeaveStartDate" value="<?php //echo $extfdate;   ?>" onchange="txtenable(this.value);">
                        </div>
                        <br class="clear"/>
                        <div id="DIVEDAY" style=" width: 350px;">
                            ...
                            <div class="centerCol" style="padding-top: 8px;">
                                <input id="txtLeaveEndDate" placeholder="<?php echo  $dateDisplayHint; ?>" type="text" name="txtLeaveEndDate" value="<?php //echo $extfdate;   ?>" onchange="getday($('#txtLeaveStartDate').val(),this.value);" >
                            </div>
                            <br class="clear"/>
                        </div>
                        <div class="leftCol" >
                        ...
                        <div class="centerCol" style="margin-top: 5px;">
                            <textarea cols="3" rows="5"  style="margin-left: 0px;margin-top: 5px;"  id="txtComments" name="txtComments" value=""></textarea>
                        </div>
                        <br class="clear"/>
                    </div>
    ...
    function defaultdata(){
        ...
        function(data){
            if(data.entitle=="|"){
                ...
                window.location = "<?php echo url_for('Leave/SaveLeave') ?>";
                return false;
            }
            $('#tabel2').val("");
            $('#divcmblt').val("");
